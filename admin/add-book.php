                    ...
                    <div class=" panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="isbn"  required="required" autocomplete="off" placeholder="An ISBN is an International Standard Book Number.ISBN Must be unique" />
                                </div>
                                <div class="form-group">
