...
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->ISBNNumber);?>"  required="required" placeholder="An ISBN is an International Standard Book Number.ISBN Must be unique"/>
<?php 
$bookid=intval($_GET['bookid']);
